...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="height:64px;">
    ...
    <div class="navbar-header">
      ...
      <a href="#" id="left-menu-toggle" class="menu-toggle" title="{{ trans('texts.toggle_navigation') }}">
          <div class="navbar-brand">
                ...
                <!--
                <img src="{{ asset('images/invoiceninja-logo.png') }}" width="150" height="auto" style="float:left"/>
              -->
                <span class="header-title">XYZ Chemincals</span>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#">Bill Discounting</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">Settlement History</a>
      </li>
      <li class="nav-item">
